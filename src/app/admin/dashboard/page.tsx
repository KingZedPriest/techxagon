    ...
    return ( 
        <main className="py-4 p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-10">
                <Summary icon={<Book size={24} className="text-white"/>} color="#fc5959" amount={10} text="Number of Schools"/>
                <Summary icon={<Teacher size={24} className="text-white"/>} color="#fc9b24" amount={10} text="Number of Teachers"/>
