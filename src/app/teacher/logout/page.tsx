            ...
            <div className="relative w-[90%] sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%] h-[15rem] bg-white p-4 md:p-8 rounded-xl">
                <div className="flex flex-col gap-y-5 xl:gap-y-3 items-center justify-center text-center">
                    ...
                    <form action={logOut} className='flex justify-between w-full'>
                        <Link href='/admin/dashboard' className='px-4 md:px-6 xl:px-8 py-2 md:py-3 rounded-xl border border-primary text-primary cursor-pointer hover:bg-primary hover:text-white duration-500'>Go home</Link>
                        <button type="submit" className="bg-[#D70015] px-4 md:px-6 xl:px-8 py-2 md:py-3 rounded-xl text-white cursor-pointer border border-[#D70015] hover:bg-white hover:text-[#D70015] duration-500">Yes</button>
                    </form>
