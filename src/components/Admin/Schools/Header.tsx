    ...
    return ( 
        <main className="flex flex-col gap-y-3 sm:gap-y-0 sm:flex-row sm:justify-between sm:items-center">
            ...
            <div className="flex gap-x-5 text-xs md:text-sm xl:text-base">
                ...
                <Link className="bg-inkBlue text-white rounded-xl px-4 py-3 border border-inkBlue hover:bg-inherit hover:text-inkBlue duration-300" href="/admin/schools/add">Add School</Link>
            </div>
        </main>
     );
}
